...
on a single leaf of a plant \footcite{yeasts+biocontrol+agent}.
...
long period of time \footcite{pickled+foods+expiration}. The acidity of your sourdough starter is quite
...
spores \footcite{old+spores}. While being spores
...
water \footcite{mold+anaerobic}. Before using the starter again simply either stir
