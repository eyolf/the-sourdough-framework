...
The style of crumb I like is called the {\it honeycomb crumb} (Fig. \ref{fig:honeycomb}). It's not too open, but
...
to this style of bread as a {\it pancake} (see Fig. \ref{fig:fermented-too-long}). The oven spring can be compared
