...
small particles called {\it hemicelluloses} (arabinoxylan and beta-glucan) \footcite{rye-defects}.
...
of the fermentation \footcite{stiff+starter}. Please
...
the tides of your starter towards a better yeast fermentation \footcite*{more+active+starter}.
...
the most. \footcite{stiff+starter}

Another non conventional approach could be to add baking
powder to your dough. The baking powder neutralizes the
lactic acid and will make a much milder dough.\footcite{baking+powder+reduce-acidity}
...
of 4.2 can be considered food safe\footcite{food+safe+ph}. This
...
metabolites that inhibit mold growth. \footcite{mold+lactic+acid+bacteria}
...
\begin{figure}[!htb]
  ...
  \caption{The interaction of lactic acid bacteria and mold fungi.
           ...
           metabolites that inhibit fungus growth. \footcite{mold+lactic+acid+bacteria}}
...
\begin{figure}[!htb]
  ...
  \caption{Hooch building on top of a sourdough starter. \footcite{liquid+on+starter}}
  \label{fig:hooch}
\end{figure}
...
\begin{figure}[!htb]
  ...
  \caption{Oxygen is required to create acetic acid \footcite{acetic+acid+production}.}
